...
const connectDB = () => {
  const refConnection = mongoose.createConnection(process.env.DB_URI_ACCES_ADMINS, {
  ...
  const mainConnection = mongoose.createConnection(process.env.DB_URI_REGISTERED_ADMINS);
