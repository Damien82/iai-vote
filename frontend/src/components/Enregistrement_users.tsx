...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-300 p-6">
      ...
      >
        <h2 className="text-2xl text-white font-bold mb-6 text-center">Inscription</h2>
        ...
        <label className="block mb-4 relative">
          ...
          <input
            ...
            required
            className={`w-full pl-10 pr-4 py-3 rounded-md text-white border bg-gray-700 border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
        ...
        {error && (
          ...
          <label className="block mb-4 relative">
  <FontAwesomeIcon icon={faQuestionCircle} className="absolute left-3 top-[18px] text-gray-400" />
  <select
    value={questiondesecurite}
    onChange={(e) => setquestiondesecurite(e.target.value)}
    required
    className="w-full pl-10 pr-3 py-3 text-white rounded-md border bg-gray-700 border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
  >
